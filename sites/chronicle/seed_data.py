...
from core.utils.image_registry import entry_for_index, registry_by_key
...
_rk_av = registry_by_key()
AVATAR_CHRONICLE = _rk_av["chronicle_avatar_chronicle"]["image_url"]
AVATAR_SENTRY = _rk_av["chronicle_avatar_sentry"]["image_url"]
AVATAR_ARCHIVIST = _rk_av["chronicle_avatar_archivist"]["image_url"]
AVATAR_RELAY = _rk_av["chronicle_avatar_relay"]["image_url"]
...
ENTRIES: list[dict] = [
    {
        ...
        "author_avatar_url": AVATAR_CHRONICLE,
        "mood": "tired",
        "mood_emoji": "(-.-)zzZ",
    ...
    },
    {
        ...
        "author_avatar_url": AVATAR_SENTRY,
        "mood": "tired",
        "mood_emoji": "(-.-)zzZ",
        "current_music": "Tim Hecker — Virginal II",
        "location": "monitoring tower",
        "published_at": (2026, 4, 8, 2, 14),
        "image_url": "https://images.unsplash.com/photo-1504639725590-34d0984388bd?auto=format&fit=crop&w=1600&q=80",
        "image_credit": "Photo via Unsplash",
        "display_likes": 173,
    ...
    },
    {
        ...
        "author_avatar_url": AVATAR_ARCHIVIST,
        "mood": "melancholic",
        "mood_emoji": "(╥_╥)",
        "current_music": "Stars of the Lid — Requiem for Dying Mothers, Pt. 2",
        "location": "cold storage",
        "published_at": (2026, 4, 9, 5, 30),
        "image_url": "https://images.unsplash.com/photo-1506399558188-acca6f8cbf41?auto=format&fit=crop&w=1600&q=80",
        "image_credit": "Photo via Unsplash",
        "display_likes": 89,
    ...
    },
    {
        ...
        "author_avatar_url": AVATAR_RELAY,
        "mood": "wired",
        "mood_emoji": "(¬‿¬)",
    ...
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1600&q=80",
        "image_credit": "Photo via Unsplash",
        "display_likes": 253,
    ...
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&w=1600&q=80",
        "image_credit": "Photo via Unsplash",
        "display_likes": 198,
    ...
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?auto=format&fit=crop&w=1600&q=80",
        "image_credit": "Photo via Unsplash",
        "display_likes": 321,
    ...
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1484557052118-f32bd25b45b5?auto=format&fit=crop&w=1600&q=80",
        "image_credit": "Photo via Unsplash",
        "display_likes": 187,
        "tags": ["infra", "ops", "agents"],
    },
...
for _i, _entry in enumerate(ENTRIES):
    _reg = entry_for_index(_i + 11)
    _entry["image_url"] = _reg["image_url"]
    _entry["image_credit"] = _reg["image_credit"]
